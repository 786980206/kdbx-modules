...
join:{[base;segments] ` sv base,segments };
...
.z.m.string:{[path]
  ...
  if[.z.o in `w32`w64; pathStr:ssr[pathStr; enlist"/"; "\\"]];
...
samefile:{[path1;path2]
  ...
  pathStr1:@[realpath; path1; ""];
  if[pathStr1~""; :0b];
  pathStr2:@[realpath; path2; ""];
  if[pathStr2~""; :0b];
  pathStr1~pathStr2
 };

export:([isFile;isDir;exists;join;split;.z.m.string;realpath;samefile]);