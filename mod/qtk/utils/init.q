...
raiseIfNameExists:{[name]
  if[nameExists name;
     'err.compose[`NameExistsError; string name]
   ];
 };
...
// It's the reverse of [intToVectorByBase](#qtkutilsinttovectorbybase), and
...
vectorToIntByBase:{[base;vector] base sv vector };

// @kind function
// @subcategory utils
// @overview Get vector representation of an integer by given base.
// It's the reverse of [vectorToIntByBase](#qtkutilsvectortointbybase), and
...
intToVectorByBase:{[base;int] base vs int};

// @kind function
// @subcategory utils
// @overview Get integer representation of an vector by given bases.
// It's the reverse of [intToVectorByBases](#qtkutilsinttovectorbybases), and
// It's an alias of [sv](https://code.kx.com/q/ref/sv/#base-to-integer).
...
vectorToIntByBases:{[bases;vector] bases sv vector };

// @kind function
// @subcategory utils
// @overview Get vector representation of an integer by given bases.
// It's the reverse of [vectorToIntByBases](#qtkutilsvectortointbybases), and
// It's an alias of [vs](https://code.kx.com/q/ref/vs/#base-x-representation).
// @param bases {short[] | int[] | long[]} Bases.
// @param int {short | int | long} An integer.
...
intToVectorByBases:{[bases;int] bases vs int};

// @kind function
// @subcategory utils
// @overview Get short/int/long from its byte representation.
// It's the reverse of [toBytesByInt](#qtkutilstobytesbyint), and
...
toIntByBytes:{[vector] 0x0 sv vector };

// @kind function
// @subcategory utils
// @overview Get byte representation of a short/int/long.
// It's the reverse of [toIntByBytes](#qtkutilstointbybytes) and
...
toBytesByInt:{[int] 0x0 vs int};

// @kind function
// @subcategory utils
// @overview Get byte/short/int/long from its bit (boolean) representation.
// It's the reverse of [toBoolsByInt](#qtkutilstoboolsbyint) and
...
toIntByBools:{[vector] 0b sv vector };

// @kind function
// @subcategory utils
// @overview Get bit (boolean) representation of a byte/short/int/long.
// It's the reverse of [toIntByBools](#qtkutilstointbybools) and
...
toBoolsByInt:{[int] 0b vs int };

export:([nameExists; raiseIfNameExists; vectorToIntByBase; intToVectorByBase; vectorToIntByBases; intToVectorByBases; toIntByBytes; toBytesByInt; toIntByBools; toBoolsByInt]);